...
val dustBlock = <exnihiloadscensio:blockDust>;
...
//recipes.addShapeless(<excompressum:compressed_block>, [dustBlock, dustBlock, dustBlock, dustBlock, dustBlock, dustBlock, dustBlock, dustBlock, dustBlock]);
