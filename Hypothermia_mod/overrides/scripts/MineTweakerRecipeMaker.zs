...
recipes.addShapeless(<minecraft:clay_ball>, [<exnihiloadscensio:itemPebble>, <minecraft:potion>.transformReplace(<minecraft:glass_bottle>), <ore:dustWood>]);
...
recipes.addShaped(<chiselsandbits:wrench_wood>, [[null, <ore:plankWood>, null],[null, <ore:stickWood>, <ore:plankWood>],[<ore:plankWood>, null, null]]);
